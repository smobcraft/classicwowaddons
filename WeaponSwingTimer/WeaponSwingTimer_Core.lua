...
local load_message = "Thank you for installing WeaponSwingTimer Version 4.0.2 by LeftHandedGlove! " .. 
...
swing_reset_spells['PALADIN'] = { -- Done
    --"Blessing of Freedom",
    --"Blessing of Kings",
	--"Blessing of Light",
    --"Blessing of Might",
...
swing_reset_spells['WARLOCK'] = { -- Done
	--"Amplify Curse"
    --"Banish",
	--"Conflagrate"
    --"Corruption",
